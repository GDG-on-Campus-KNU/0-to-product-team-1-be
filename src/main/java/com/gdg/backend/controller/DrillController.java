...
public class DrillController {
    ...
    @GetMapping("/today")
    public ResponseEntity<DrillTodayResponse> getTodayDrill(@AuthenticationPrincipal User user) {
        return ResponseEntity.ok(drillService.getTodayDrill(user.getUserId()));
    }
}
